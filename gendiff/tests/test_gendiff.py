...
def test_generate_diff(test_generate_diff_exp):
    ...
    diff = generate_diff(ADDRESS + 'flat1.json', ADDRESS + 'flat2.json')
...
def test_generate_diff_json():
    # Check if function generate_diff works correctly
    diff = generate_diff(ADDRESS + 'file1.json', ADDRESS + 'file2.json', 'json')
